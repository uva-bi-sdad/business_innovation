...
```{r}
as.data.frame(get_context_pos(word_vec = test, target = "melafind", n = 1, p_o_s = "Adjective") )

as.data.frame(unique(tidytext::parts_of_speech$pos))
```
