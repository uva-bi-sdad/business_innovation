...
doublebars_perc_3prox <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/doublebars_3proxmethods_2020may07.RDS")
doublebars_perc_4comb <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/doublebars_4combmethods_2020may07.RDS")
```
...
Proximity - 3 + BRAND | `r length(unique(doublebars_perc_4comb$family))`| `r scales::percent(mean(doublebars_perc_4comb$val_perc1))` | `r scales::percent(sd(doublebars_perc_4comb$val_perc1)) ` |`r scales::percent(mean(doublebars_perc_4comb$ndc_perc1)) ` | `r scales::percent(sd(doublebars_perc_4comb$ndc_perc1)) `
...
```{r}
top10val_perc2 <- doublebars_perc %>% arrange(desc(val_perc1), desc(unval)) %>% head(10) %>% select(family,  val, unval)
top10val_perc2 <- top10val_perc2 %>% reshape2::melt(value.name = "n") %>% left_join(doublebars_perc %>% arrange(desc(val_perc1), desc(unval)) %>% select(family, val_perc1, val_perc), by = "family")

ggplot(top10val_perc2, aes(x = reorder(family, val_perc1), y = n,  fill = reorder(variable, n))) +
  geom_bar(stat = "identity") +
  geom_text(data = top10val_perc2 %>% filter(variable == "val"), aes(y = 500, label = scales::percent(val_perc1))) +
  coord_flip() +
  customPlot2 +
  scale_fill_manual(values = c("#fcba03", "#198a00") ) +
  labs(title = "SEC Capture Validation Rates \nof Top 10 Filers", subtitle = "(top 10 by total captures)") +
...
ggplot(top10val_perc2, aes(x = reorder(family, val_perc1), y = n,  fill = reorder(variable, n))) +
  geom_bar(stat = "identity") +
  geom_text(data = top10val_perc2 %>% filter(variable == "val"), aes(y = 20, label = scales::percent(val_perc1))) +
  coord_flip() +
  customPlot2 +
  scale_fill_manual(values = c("#fcba03", "#198a00") ) +
  labs(title = "SEC Capture Validation Rates \nof Top 10 Filers", subtitle = "(top 10 by total captures)") +
...
```{r eval = FALSE}
all_eng_portfolio_results <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/allnoneng_val_portf_check_may062020.RDS")
prox_launch_portfolio_results <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/launch_val_portf_check_may062020.RDS")
prox_newprod_portfolio_results <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/newprod_val_portf_check_may062020.RDS")
prox_newdrug_portfolio_results <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/newdrug_val_portf_check_may062020.RDS")
prox_newdevice_portfolio_results <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/newdevice_val_portf_check_may062020.RDS")
brand_portfolio_match <- readRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/brand_val_portf_check_may062020.RDS")
```
...
ggplot(top10val_perc2, aes(x = reorder(family, val_perc1), y = n,  fill = reorder(variable, n))) +
  geom_bar(stat = "identity") +
  geom_text(data = top10val_perc2 %>% filter(variable == "val"), aes(y = n + 1, label = scales::percent(val_perc1))) +
  coord_flip() +
  customPlot2 +
  scale_fill_manual(values = c("#fcba03", "#198a00") ) +
  labs(title = "SEC Capture Validation Rates \nof Top 10 Filers", subtitle = "(top 10 by total captures)") +
...
#### 3 Proximity - Comparing Validation and Detection Rates 
...
ggplot(data = doublebars_perc, aes(x = val_perc1, y = ndc)) +
  ...
  geom_text(data = doublebars_perc %>% filter(ndc > 50), 
            aes(label = family, vjust = -0.4, hjust = 0.4)) +
  customPlot2 +
  labs(title = "3 Proximity - Validation Rates \nby NDC Portfolio Size") +
  xlab("SEC Capture Validation Rate \nPer Company (Labeler)") + 
  ylab("NDC Portfolio Size \n(by Unique Proprietary Drug Names)")
```
...
ggplot(data = doublebars_perc, aes(x = ndc_perc1, y = ndc)) +
  ...
  geom_text(data = doublebars_perc %>% filter(ndc > 50), 
            aes(label = family, vjust = -0.4, hjust = 0.4)) +
  customPlot2 +
  labs(title = "3 Proximity - Detection Rates \nby NDC Portfolio Size") +
  xlab("NDC Detection Rate \nPer Company (Labeler)") + 
  ylab("NDC Portfolio Size \n(by Unique Proprietary Drug Names)")
```
...
## Proximity - 3 Methods Combined + BRAND
...
total_unval_brand <- final_product_list_brand %>% 
  mutate(Company = as.numeric(Company)) %>%
  inner_join(ndc_sec_ref %>% select(cik, LABELERNAME = ndc_labeler, family), by = c("Company" = "cik")) %>%
  select(family, Token, Brand, Name) %>% 
  count(family, Token) %>% select(-n)

total_unval <- rbind(total_unval_launch, total_unval_product, total_unval_drug, total_unval_brand) %>% distinct()  %>% 
  count(family) %>% 
  mutate(sec = "unval")
```
...
total_val_brand <- ndc_validateset_results_brand %>% 
  #filter(as.character(cik) %in% ndc_sec_ref$cik) %>% 
  filter(!is.na(Prop_matches)|!is.na(NonProp_matches)) %>%
  # filter(Self == 1) %>% 
  count(family, drug = PROPRIETARYNAME) %>% #str_to_lower(ifelse(!is.na(Prop_matches), Prop_matches, NonProp_matches))) %>% 
...
total_val <- rbind(total_val_launch, total_val_product, total_val_drug, total_val_brand) %>% distinct() %>%
  count(family) %>% 
  mutate(sec = "val")

 # rbind(total_val_launch, total_val_product, total_val_drug, total_val_brand) %>% distinct()  %>% filter(family == "alimera")
```
...
# doublebars_perc %>% saveRDS("/project/biocomplexity/sdad/projects_data/ncses/bi/binn/working/sec/wordlist_april21_2020_MANIP/doublebars_4combmethods_2020may07.RDS")
```
...
ggplot(data = doublebars_perc, aes(x = val_perc1, y = ndc)) +
  ...
  geom_text(data = doublebars_perc %>% filter(ndc > 50), 
            aes(label = family, vjust = -0.4, hjust = 0.4)) +
  customPlot2 +
  labs(title = "4 Combined - Validation Rates \nby NDC Portfolio Size") +
  xlab("SEC Capture Validation Rate \nPer Company (Labeler)") + 
  ylab("NDC Portfolio Size \n(by Unique Proprietary Drug Names)")
```
...
ggplot(data = doublebars_perc, aes(x = ndc_perc1, y = ndc)) +
  ...
  geom_text(data = doublebars_perc %>% filter(ndc > 50), 
            aes(label = family, vjust = -0.4, hjust = 0.4)) +
  customPlot2 +
  labs(title = "4 Combined - Detection Rates \nby NDC Portfolio Size") +
  xlab("NDC Detection Rate \nPer Company (Labeler)") + 
  ylab("NDC Portfolio Size \n(by Unique Proprietary Drug Names)")
```
