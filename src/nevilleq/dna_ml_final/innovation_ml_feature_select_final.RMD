...
ggsave("./src/nevilleq/dna_ml_final/innovation_ml_figures/19_8_1_inn_roc_2.jpg", roc.gg)
```
...
```{r echo = FALSE, include = FALSE}
ggsave("./src/nevilleq/dna_ml_final/innovation_ml_figures/19_8_1_inn_cost_2.jpg", cost.gg)
```
...
boot.df <- list.files(file.path, ".RDS")
