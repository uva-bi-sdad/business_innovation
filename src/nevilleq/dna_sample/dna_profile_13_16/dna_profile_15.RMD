...
head(dna.2.dt$company_codes)
head(dna.2.dt$company_codes_about)
...
head(dna.3.dt$company_codes)
head(dna.3.dt$company_codes_about)
head(dna.3.dt$filter_company)
head(dna.3.dt$filter_company_about)
...
map_lgl(dna.3.dt$subject_codes, is.na) %>% sum()
map_lgl(dna.3.dt$subject_codes, is.na) %>% mean()
