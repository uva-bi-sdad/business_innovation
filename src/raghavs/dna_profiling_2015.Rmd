...
c22_2015 <- filter(dna.3.dt,grepl("c22",dna.3.dt$subject_codes))
#write.csv(c22_2015,"./data/working/DNA_Aggregated/c22_articles_2015.csv")
# Filter out all business/disruptive innovation articles in 2015
cdinn_2015 <- filter(dna.3.dt,grepl("cdinn",dna.3.dt$subject_codes))

# Filter out all SEC filing articles in 2015
cgvfil_2015 <- filter(dna.3.dt,grepl("cgvfil",dna.3.dt$subject_codes))
...
not_c22_2015_filtered <- filter(z, !grepl("c22",z$subject_codes)) 
write.csv(not_c22_2015_filtered, "./data/working/DNA_Aggregated/not_c22_filtered_2015.csv")
